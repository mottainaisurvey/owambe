...
-- ─── 7. Seed all 41 categories with mode-affinity flags ─────────────────────
INSERT INTO "vendor_category_lookup" ("key", "label", "description", "modeAffinities", "sortOrder", "updatedAt")
VALUES
  -- Events (21 categories)
  ('VENUE',               'Venue',                    'Event venues and spaces',                    ARRAY['EVENTS'],                       1,  NOW()),
  ('CATERING',            'Catering',                 'Food and catering services',                  ARRAY['EVENTS'],                       2,  NOW()),
  ('WEDDING_CAKES',       'Wedding Cakes',            'Wedding and celebration cakes',               ARRAY['EVENTS'],                       3,  NOW()),
  ('BAR_BEVERAGE',        'Bar & Beverage',           'Bar setup and beverage services',             ARRAY['EVENTS'],                       4,  NOW()),
  ('AV_PRODUCTION',       'AV & Production',          'Audio-visual and stage production',           ARRAY['EVENTS'],                       5,  NOW()),
  ('CONFERENCE_AV',       'Conference AV',            'Conference and corporate AV services',        ARRAY['EVENTS'],                       6,  NOW()),
  ('PHOTOGRAPHY_VIDEO',   'Photography & Video',      'Event photography and videography',           ARRAY['EVENTS', 'STAYS'],              7,  NOW()),
  ('PRE_WEDDING',         'Pre-Wedding',              'Pre-wedding shoots and services',             ARRAY['EVENTS'],                       8,  NOW()),
  ('DECOR_FLORALS',       'Décor & Florals',          'Event decoration and floral arrangements',    ARRAY['EVENTS'],                       9,  NOW()),
  ('ENTERTAINMENT',       'Entertainment',            'Live entertainment and performers',            ARRAY['EVENTS', 'EXPERIENCES'],       10,  NOW()),
  ('MC_EMCEE',            'MC / Emcee',               'Master of ceremonies',                        ARRAY['EVENTS'],                      11,  NOW()),
  ('MAKEUP_ARTIST',       'Makeup Artist',            'Professional makeup and styling',             ARRAY['EVENTS'],                      12,  NOW()),
  ('SPEAKER',             'Speaker',                  'Keynote and event speakers',                  ARRAY['EVENTS'],                      13,  NOW()),
  ('ASO_EBI',             'Aso-Ebi',                  'Fabric and aso-ebi coordination',             ARRAY['EVENTS'],                      14,  NOW()),
  ('BRIDAL_JEWELLERY',    'Bridal Jewellery',         'Bridal jewellery and accessories',            ARRAY['EVENTS'],                      15,  NOW()),
  ('USHERS_HOSTESSES',    'Ushers & Hostesses',       'Event ushers and hostesses',                  ARRAY['EVENTS'],                      16,  NOW()),
  ('EVENT_SECURITY',      'Event Security',           'Security services for events',                ARRAY['EVENTS'],                      17,  NOW()),
  ('EVENT_COORDINATION',  'Event Coordination',       'Full event planning and coordination',        ARRAY['EVENTS'],                      18,  NOW()),
  ('BRANDING_SIGNAGE',    'Branding & Signage',       'Event branding, banners and signage',         ARRAY['EVENTS'],                      19,  NOW()),
  ('SOUVENIR_SOURCING',   'Souvenir Sourcing',        'Event souvenirs and gifts',                   ARRAY['EVENTS'],                      20,  NOW()),
  ('SET_DESIGN',          'Set Design',               'Stage and set design services',               ARRAY['EVENTS'],                      21,  NOW()),
  ('CHILDRENS_PARTY',     'Children''s Party',        'Children''s party entertainment',             ARRAY['EVENTS'],                      22,  NOW()),
  -- Stays (10 categories)
  ('CLEANING_HOUSEKEEPING','Cleaning & Housekeeping', 'Property cleaning and housekeeping',          ARRAY['STAYS'],                       23,  NOW()),
  ('PROPERTY_MAINTENANCE', 'Property Maintenance',   'Property repair and maintenance',             ARRAY['STAYS'],                       24,  NOW()),
  ('LAUNDRY',             'Laundry',                  'Laundry and linen services',                  ARRAY['STAYS'],                       25,  NOW()),
  ('PROPERTY_SECURITY',   'Property Security',        'Security services for properties',            ARRAY['STAYS'],                       26,  NOW()),
  ('INTERIOR_DESIGN',     'Interior Design',          'Interior design and staging',                 ARRAY['STAYS'],                       27,  NOW()),
  ('LISTING_PHOTOGRAPHY', 'Listing Photography',      'Property listing photography',                ARRAY['STAYS'],                       28,  NOW()),
  ('LOCAL_TRANSPORT',     'Local Transport',          'Local transport and driver services',         ARRAY['STAYS', 'EXPERIENCES'],        29,  NOW()),
  ('AIRPORT_PICKUP',      'Airport Pickup',           'Airport transfer services',                   ARRAY['STAYS', 'EXPERIENCES'],        30,  NOW()),
  ('IN_PROPERTY_CATERING','In-Property Catering',    'Private chef and in-property catering',       ARRAY['STAYS'],                       31,  NOW()),
  ('CONCIERGE',           'Concierge',                'Concierge and guest services',                ARRAY['STAYS', 'EXPERIENCES'],        32,  NOW()),
  -- Experiences (9 categories)
  ('TOUR_GUIDES',         'Tour Guides',              'Local tour guides',                           ARRAY['EXPERIENCES'],                 33,  NOW()),
  ('BOAT_CHARTER',        'Boat Charter',             'Boat and yacht charter services',             ARRAY['EXPERIENCES'],                 34,  NOW()),
  ('EQUIPMENT_RENTAL',    'Equipment Rental',         'Activity equipment rental',                   ARRAY['EXPERIENCES'],                 35,  NOW()),
  ('TOURISM_TRANSPORT',   'Tourism Transport',        'Transport for tourism activities',            ARRAY['EXPERIENCES'],                 36,  NOW()),
  ('WELLNESS_SPA',        'Wellness & Spa',           'Wellness, spa and massage services',          ARRAY['EXPERIENCES'],                 37,  NOW()),
  ('CULTURAL_WORKSHOPS',  'Cultural Workshops',       'Cultural and craft workshops',                ARRAY['EXPERIENCES'],                 38,  NOW()),
  ('ADVENTURE_ACTIVITIES','Adventure Activities',     'Adventure and outdoor activities',            ARRAY['EXPERIENCES'],                 39,  NOW()),
  ('SUB_GUIDES',          'Sub-Guides',               'Specialist sub-guides and assistants',        ARRAY['EXPERIENCES'],                 40,  NOW()),
  ('TRAVEL_DOCUMENTATION','Travel Documentation',    'Visa and travel documentation assistance',    ARRAY['EXPERIENCES'],                 41,  NOW())
